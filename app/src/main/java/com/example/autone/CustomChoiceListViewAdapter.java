...
public class CustomChoiceListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_of_signals, parent, false);
        }
        ...
        checkBox.setOnCheckedChangeListener((buttonView, isChecked) -> listViewItem.setChecked(isChecked));
